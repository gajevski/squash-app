...
export class AppComponent {
  ...
  public buttons = [
    { label: 'Action 1', color: 'bg-blue-500 hover:bg-blue-700', action: () => {} },
    { label: 'Action 2', color: 'bg-green-500 hover:bg-green-700', action: () => {} },
    { label: 'Action 3', color: 'bg-red-500 hover:bg-red-700', action: () => {} },
  ];
